fn p1(input: Vec<&str>) -> (isize, isize) {
    let length = input[0].len();
    println!("len: {}", length);

    let mut gamma_rate_binary = String::from("");
    ...
    for i in 0..length {
        if has_equal_or_more_ones(&input, i) {
            ...
            gamma_rate_binary.push_str("0");
            epsilon_rate_binary.push_str("1");
        }
    }
    println!("gamma: {}", gamma_rate_binary);
